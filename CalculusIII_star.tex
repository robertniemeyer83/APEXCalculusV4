...
%\printexercisenames
%\printincolor
\ifthenelse{\boolean{color}}{\printincolor}{\printinblackandwhite}
...
\include{text/09_Conic_Sections}
\include{text/09_Parametric_Equations}
\include{text/09_Parametric_Calculus}
\include{text/09_Polar_Intro}
\include{text/09_Polar_Calculus}
...
\thispagestyle{empty}
\include{text/10_Space_Intro}
\include{text/10_Vector_Introduction}
\include{text/10_Dot_Product}
\include{text/10_Cross_Product}
\include{text/10_Lines}
\include{text/10_Planes}
\include{text/10_Matrix_Arithmetic}
...
\thispagestyle{empty}
\include{text/11_Vector_Functions_Intro}
\include{text/11_Vector_Functions_Calc}
\include{text/11_Vector_Functions_Motion}
\include{text/11_Vector_Tangent_Normal}
\include{text/11_Arc_Length_Parameter_Curvature}

\clearpage{\pagestyle{empty}\cleardoublepage}
\chapter{Functions of Several Variables}\label{chapter:multi}
\thispagestyle{empty}
\include{text/12_Multivariable_Intro}
\include{text/12_Multivariable_Limit}
\include{text/12_Partial_Derivatives}
\include{text/12_Total_Differential}
\include{text/12_Multivariable_Chain_Rule}
\include{text/12_Directional_Derivatives}
\include{text/12_Tangent_Planes_Lines}
\include{text/12_Extrema}
\include{text/12_Derivative_Matrix}
\include{text/12_Further_Extrema}
...
\thispagestyle{empty}
\include{text/13_Iterated_Integrals}
\include{text/13_Double_Integrals_Volume}
\include{text/13_Double_Integrals_Polar}
\include{text/13_Center_of_Mass}
\include{text/13_Surface_Area}
\include{text/13_Triple_Integration}
\include{text/13_Cylindrical_Spherical}
\include{text/13_Transformations}
\addtocontents{toc}{\protect\thispagestyle{empty}}

\clearpage{\pagestyle{empty}\cleardoublepage}
\chapter{Vector Analysis}\label{chapter:vector_calc}
\thispagestyle{empty}
\include{text/14_Line_Integral_Intro}
\include{text/14_Vector_Fields}
\include{text/14_Line_Integral_Vector_Fields}
\include{text/14_Line_Integral_Greens_Theorem}
\include{text/14_Parametrized_Surfaces}
\include{text/14_Surface_Integrals}
\include{text/14_Stokes_Divergence}
\include{text/14_Stokes_Proof}
